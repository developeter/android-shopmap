	...
	protected void onCreate(Bundle savedInstanceState) {
            ...
            query.findInBackground(new FindCallback<ParseObject>() {
                    ...
                    if (e == null) {
                            ...
                            for (ParseObject object:listNegozi) {
                                    ...
                                    float dist = (float) pos.distanceInKilometersTo(userposition);
                                    String str = String.format("%.0f", (dist*1000) - 0.005);
                                    attivita[2] = str + "m";
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
				...
				String data = ((TextView) view.findViewById(R.id.nome)).getText().toString();
				bundle.putString("NOME", data);
				Intent aggiungi = new Intent(ActivityLista.this,ActivityDettaglio.class);
